...
data "aws_ssm_parameter" "artifacts_bucket_arn" { name = "/i2508dr/ci/artifacts_bucket_arn" }
data "aws_ssm_parameter" "ci_role_arn" { name = "/tf-rds-cross-region-dr/ci-role-arn" }
